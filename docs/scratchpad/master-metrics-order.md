# Master Metrics Order
----------------------------------------
When contributing a new metric, please reference this list in order to make sure you are putting the metric in the correct spot in the code. With the amount of metrics we have already, and plan to add, this helps contributors both new and old maintain clarity and order when working with metrics. 
...
* Files where metrics appear should include a header for every group, even if there are no relevant metrics in that group.
* If you are adding an Experimental metric, please add it to correct sub-category in alphabetical order. If you would like to add a new Experimental sub-category, please open a pull request with your proposed addition.

All links pulled from the [Linux Foundation Working Group Repository.](https://github.com/OSSHealth/wg-gmd)
...
Implementation Status | Metric
--|--
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| [Closed Issues](https://github.com/OSSHealth/wg-gmd/blob/master/activity-metrics/closed-issues.md/)
| <ul><li>- [ ] Frontend</li><li>- [x] Backend</li></ul>| [Closed Issue Resolution Duration](https://github.com/OSSHealth/wg-gmd/blob/master/activity-metrics/closed-issue-resolution-duration.md/)
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| [Code Commits](https://github.com/OSSHealth/wg-gmd/blob/master/activity-metrics/code-commits.md/)
...
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| [Code Review Iteration](https://github.com/OSSHealth/wg-gmd/blob/master/activity-metrics/code-review-iteration.md/)
...
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| [Contribution Acceptance](https://github.com/OSSHealth/wg-gmd/blob/master/activity-metrics/contribution-acceptance.md/)
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| [Contributing Organizations](https://github.com/OSSHealth/wg-gmd/blob/master/activity-metrics/contributing-organizations.md/)
...
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| [Forks](https://github.com/OSSHealth/wg-gmd/blob/master/activity-metrics/forks.md/)
...
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| [Maintainer Response to Merge Request Duration](https://github.com/OSSHealth/wg-gmd/blob/master/activity-metrics/maintainer-response-to-merge-request-duration.md/)
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| [New Contributing Organizations](https://github.com/OSSHealth/wg-gmd/blob/master/activity-metrics/new-contributing-organizations.md/)
...
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| [Open Issues](https://github.com/OSSHealth/wg-gmd/blob/master/activity-metrics/open-issues.md/)
...
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| [Pull Request Comments](https://github.com/OSSHealth/wg-gmd/blob/master/activity-metrics/pull-request-comments.md/)
...
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| [Pull Requests Open](https://github.com/OSSHealth/wg-gmd/blob/master/activity-metrics/pull-requests-open.md/)
...
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| Commit Comments
| <ul><li>- [ ] Frontend</li><li>- [x] Backend</li></ul>| Commiter Locations
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| Total Committers

#### Issue Related
Implementation Status | Metric
--|--
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| Issue Activity

#### Pull Request Related
Implementation Status | Metric
--|--
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| Pull Request Acceptance Rate

#### Community / Contributions
Implementation Status | Metric
--|--
| <ul><li>- [ ] Frontend</li><li>- [x] Backend</li></ul>| Community Age
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| Community Engagement
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| Contributors
| <ul><li>- [ ] Frontend</li><li>- [x] Backend</li></ul>| Contributions
| <ul><li>- [ ] Frontend</li><li>- [x] Backend</li></ul>| Project Age
...
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| Changes By Author
| <ul><li>- [ ] Frontend</li><li>- [x] Backend</li></ul>| Downloads
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| Fakes
| <ul><li>- [x] Frontend</li><li>- [x] Backend</li></ul>| Lines Changed Minus Whitespace
