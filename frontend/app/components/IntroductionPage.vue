...
<form class="description-input" :action="formAction" method="post">
        <div class="user-input" data-validate="Enter username">
          <input class="input" type="text" name="description" placeholder="Enter Description">
        </div>
...
module.exports = {
    data() {
      return {
        'formAction':  encodeURI('http://www.google.com')
      }
    },
    methods: {
    },
...
>>>>>>> aab2258ff5171d9efb2b64ecd4affad1bf1804d0
</script>